...
def main(
    ...
    for batch in tqdm(batchs):
        ...
        results, layer_stat = model.generate_router_stat(prompts, max_gen_len=max_gen_len, temperature=temperature, top_p=top_p)

        if not layer_stat_all:
    ...
    route_stats_path = save_path.replace('.jsonl','route_stats.pth')
