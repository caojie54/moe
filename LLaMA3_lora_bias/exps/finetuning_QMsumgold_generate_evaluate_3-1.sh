...
tag=""
path="/home2/caojie"
output_dir="${path}/outputs/LLaMA3-1_lora_bias/${dataset}/b32_epoch${epochs}_warme1_lorar${lora_rank}_lora${lora_targets}_blr${blr}_maxseq${max_seq_len}_flashatt2${flash_attention2}_bf16${bf16}_${tag}/"
