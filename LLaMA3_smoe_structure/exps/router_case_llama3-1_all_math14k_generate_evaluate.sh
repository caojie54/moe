...
test_dataset_l="SVAMP"

for test_dataset in $test_dataset_l
do
save_path="${output_dir}${test_dataset}_mingen${min_gen_len}_router_case.jsonl"
torchrun --nproc_per_node $num_devices --master_port=3238 example_router_case.py \
