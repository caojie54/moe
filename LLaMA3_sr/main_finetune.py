...
def get_args_parser():
    ...
    # lora
    parser.add_argument('--w_bias', type=str2bool, nargs='?', const=True, default=False, help='bias tuning')
    parser.add_argument('--w_lora', type=str2bool, nargs='?', const=True, default=False, help='lora tuning')
    ...
    parser.add_argument('--expert_num', default=2, type=int, help='expert num,2:[0,1, 0 denote skip computation, n denote n times computation')
