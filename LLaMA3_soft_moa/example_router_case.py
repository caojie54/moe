...
def main(
    ...
    for batch in tqdm(batchs):
        ...
        results, layer_stat = model.generate_router_case(prompts, max_gen_len=max_gen_len, temperature=temperature, top_p=top_p)

        layer_stat_all.append(layer_stat)
    ...
    route_stats_path = save_path.replace('.jsonl','router_case.pth')
    torch.save(layer_stat_all, route_stats_path)
